...
Definovať proces získania detailných informácií o konkrétnej platbe v systéme Smart Restaurant AI.

---

# Business cieľ

Umožniť bezpečný prístup k informáciám o platbe podľa oprávnení používateľa alebo systémového modulu.
...
Endpoint vráti detail jednej konkrétnej platby podľa jej identifikátora.

Prístup k údajom o platbe je riadený oprávneniami.

Payment modul poskytuje iba informácie o platbe a nezasahuje do objednávky ani jej stavu.
...
4. Systém skontroluje, či má žiadateľ povolený prístup k údajom.
...
- Payment ID je vždy viazané na konkrétne Order ID.
...
- Rozšírené reportovanie platieb.
